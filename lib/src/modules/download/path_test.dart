...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<List<Directory>?>? _downloadsMobileDirectory;
  ...
  Widget _buildDirectory(
    ...
    if (snapshot.connectionState == ConnectionState.done) {
      if (snapshot.hasError) {
        ...
        print('paths: ${snapshot.data!.path}');
      } else {
  ...
  void _requestMobileDownloadsDirectory() {
    setState(() {
      _downloadsMobileDirectory =
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      !Platform.isAndroid
                          ? 'External directories are unavailable'
                          : 'Get External Storage Directories - Download',
                    ),
                  ),
                ),
                FutureBuilder<List<Directory>?>(
